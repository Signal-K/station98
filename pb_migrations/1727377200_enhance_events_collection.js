...
migrate((db) => {
  ...
  collection.schema.addField(new SchemaField({
    "system": false,
    "id": "window_start_" + Math.random().toString(36).substr(2, 9),
    "name": "window_start",
    "type": "date",
    "required": false,
    "presentable": false,
  ...
  collection.schema.addField(new SchemaField({
    "system": false,
    "id": "window_end_" + Math.random().toString(36).substr(2, 9), 
    "name": "window_end",
    "type": "date",
    "required": false,
    "presentable": false,
  ...
  collection.schema.addField(new SchemaField({
    "system": false,
    "id": "infographic_" + Math.random().toString(36).substr(2, 9),
    "name": "infographic", 
    "type": "url",
    "required": false,
    "presentable": false,
  ...
  collection.schema.addField(new SchemaField({
    "system": false,
    "id": "webcast_live_" + Math.random().toString(36).substr(2, 9),
    "name": "webcast_live",
    "type": "bool",
    "required": false,
    "presentable": false,
  ...
  collection.schema.addField(new SchemaField({
    "system": false,
    "id": "status_abbrev_" + Math.random().toString(36).substr(2, 9),
    "name": "status_abbrev",
    "type": "text",
    "required": false,
    "presentable": false,
  ...
  collection.schema.addField(new SchemaField({
    "system": false,
    "id": "status_description_" + Math.random().toString(36).substr(2, 9),
